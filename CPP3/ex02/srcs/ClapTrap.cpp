...
{
    std::cout << "Name constructor call";
    std::cout << BLUE << "                     Claptrap" << RESET << std::endl;
}

ClapTrap::ClapTrap(  int hitpoint, int mana, int atkDmg ) : _hitPoint(hitpoint), _energyPoint(mana), _attackDmg(atkDmg)
{
    std::cout <<  "Attributes constructor call";
    std::cout << BLUE << "                     Claptrap" << RESET << std::endl;
}

ClapTrap::ClapTrap( std::string name,  int hitpoint, int mana, int atkDmg ) : _name(name), _hitPoint(hitpoint), _energyPoint(mana), _attackDmg(atkDmg)
{
    std::cout <<  "Attributes constructor call";
    std::cout << BLUE << "                     Claptrap" << RESET << std::endl;
}
